...
;-------------------configuracion----------------------------
 ...
 ; para poder obtener un delay/salto de 100ms.
    ...
    banksel TRISA
    bcf OPTION_REG, 5 ; ((OPTION_REG) and 07Fh), 5 = TMR0 Clock Source Select Bit = reloj interno, bcf para encenderlo, uso el BIT 5.
    bcf OPTION_REG, 3 ; ((OPTION_REG) and 07Fh), 3 = Prescaler Assignment Bit = necesito asignar un valor al modulo, utilizo el BIT 3 en cero.
...
# 155 "LAB03_FINAL.s"
 ...
 ;---------------------------contador--------------------------------------
 contador_100ms:
    btfss ((INTCON) and 07Fh), 2 ; Elijo saltarme la bandera (overflow), si esta está activada FFh --> 00h.
    goto $-1
 ...
 incrementar_display:
    ...
    btfsc PORTB, 0 ; SE INCREMENTA EN BASE AL ANTIRREBOTE --> Mientras presionado ((PORTB) and 07Fh), 0 (antirrebote), aumente el PUERTO C.
